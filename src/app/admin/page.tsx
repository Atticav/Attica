          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="font-lora text-xs text-brand-muted mt-0.5">Ver e editar perfis de clientes</p>
              </div>
            </div>
          </Card>
          <Card
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="font-lora text-xs text-brand-muted mt-0.5">Criar e editar itinerários</p>
              </div>
            </div>
          </Card>
        </div>
