...
const sections = [
  { icon: Map, label: 'Roteiro', desc: 'Dia a dia da sua viagem', color: 'text-blue-400' },
  { icon: DollarSign, label: 'Financeiro', desc: 'Controle de gastos e pagamentos', color: 'text-green-500' },
  { icon: FileText, label: 'Documentos', desc: 'Passaportes, vistos e mais', color: 'text-brand-gold' },
  { icon: Luggage, label: 'Mala Inteligente', desc: 'Lista de itens para empacotar', color: 'text-purple-400' },
  { icon: CheckSquare, label: 'Checklist', desc: 'Tarefas antes da viagem', color: 'text-brand-success' },
  { icon: Compass, label: 'Central Estratégica', desc: 'Links e informações essenciais', color: 'text-brand-brown' },
  { icon: PlayCircle, label: 'Guia Attica', desc: 'Vídeos e tutoriais exclusivos', color: 'text-red-400' },
  { icon: ImageIcon, label: 'Galeria', desc: 'Fotos e vídeos do destino', color: 'text-pink-400' },
  { icon: UtensilsCrossed, label: 'Restaurantes', desc: 'Indicações gastronômicas', color: 'text-orange-400' },
  { icon: Camera, label: 'Fotografia', desc: 'Dicas para fotos incríveis', color: 'text-cyan-500' },
  { icon: Globe, label: 'Cultura', desc: 'Costumes e informações locais', color: 'text-indigo-400' },
  { icon: BookOpen, label: 'Vocabulário', desc: 'Palavras e frases essenciais', color: 'text-teal-500' },
  { icon: ScrollText, label: 'Contrato', desc: 'Documentos e acordos', color: 'text-brand-muted' },
]
